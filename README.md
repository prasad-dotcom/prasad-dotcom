...
|---|---|---|
| [**AutoConfig Review System**](https://github.com/prasad-dotcom/Anamoly-File-Comparsion) | `Python` `Flask` `SQLite` `Pandas` | GCP TDD automation · 70% manual effort reduction |
| [**FreelanceConnect**](https://github.com/prasad-dotcom/DJANGO-Fullstack) | `Django` `DRF` `ReactJS` `PostgreSQL` `JWT` | Role-based hiring platform · chatbot · full pipeline |
| [**GreatCart**](https://github.com/prasad-dotcom/GreatKart---Secured-Ecommerce-platform) | `Django` `ReactJS` `Bootstrap` `SQL` | Secured e-commerce · honey-trap auth · 500+ test users |
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=prasad-dotcom&style=flat-square&color=60a5fa&label=profile+views"/>
</p>
